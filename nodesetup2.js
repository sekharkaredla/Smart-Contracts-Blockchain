...
request('https://s3.ap-south-1.amazonaws.com/smart-contracts-blockchain/candidate_'+'id75'+'.json', { json: true }, (err, res, body) => {
...
setTimeout(function(){
	...
	s3.putObject({Bucket: 'smart-contracts-blockchain',Key: 'contract_'+'id75'+'.json',Body: JSON.stringify(obj),ACL:'public-read' ,ContentType: "application/json"},function(err,data){console.log(JSON.stringify(err));});
